...
QRoPE is patent pending.

U.S. provisional patent application: `64/068,121`

## Copyright and software license

Copyright 2026 Quantyra contributors.

The repository software is licensed under `AGPL-3.0-only`. See `LICENSE` and `NOTICE`.

## Research and review use
...
The patent notice does not expand the scientific claim boundary. Public statements should not claim broad quantum advantage, transformer-scale superiority, or general cross-backend robustness unless later evidence supports those claims.

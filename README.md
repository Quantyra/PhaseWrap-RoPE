...
| 58 | Stronger decoder-only transformer | Redesign beyond Stage 59 enough to internalize the support-aware cue rule inside a matched decoder, then rerun the same fair comparison. |
| 59 | Larger or error-aware witnesses | Explore larger qubit witnesses or mitigation analysis after downstream and replication evidence justify the added complexity. |

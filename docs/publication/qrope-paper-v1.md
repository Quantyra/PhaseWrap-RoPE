...
- Stage 6, Stage 7, Stage 8, Stage 9, Stage 10, Stage 12, Stage 13, Stage 14, Stage 15, Stage 16, Stage 17, and Stage 18 are toy downstream, retrieval, compact trained positional-attention, positional-adapter, attention-readout, learned attention-readout, stability, value-output capacity, or very small transformer experiments, not production transformer evaluations.
...
| 3 | Comparable PhaseWrap mechanism | Stage 13 through Stage 18 now test adapters around PhaseWrap features and show that explicit distance terms are needed on exact-offset retrieval and value readout. Stages 17 and 18 also show the learned value-output path needs capacity and optimization hardening before stronger transformer claims. |

...
| Next downstream gate | Stronger decoder-only transformer | Replace or materially strengthen the decoder-only implementation beyond the Stage 51 plateau enough to generalize on retrieval tasks, then rerun the same fair comparison. |

...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 61 enough to establish learned capacity before testing positional-method promotion. |

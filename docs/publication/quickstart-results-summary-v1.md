...
| Next downstream gate | Stronger decoder-only transformer | Replace or materially strengthen the decoder-only implementation beyond copy-output repair enough to generalize on retrieval tasks, then rerun the same fair comparison. |

...
| Next downstream gate | Stronger decoder-only transformer | Replace hard support-to-token routing with learned matched decoder behavior before positional-method promotion. |

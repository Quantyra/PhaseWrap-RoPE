...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 65 enough to improve held-out retrieval generalization before testing positional-method promotion. |

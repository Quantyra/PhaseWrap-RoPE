...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond the Stage 53 two-block hardening path enough to generalize on retrieval tasks, then rerun the same fair comparison. |

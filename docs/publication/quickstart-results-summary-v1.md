...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond the Stage 55 metadata upper bound enough to infer retrieval cues from standard inputs, then rerun the same fair comparison. |

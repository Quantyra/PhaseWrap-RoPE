...
| Next downstream gate | Matched decoder-only transformer or bounded plateau | Move the same fair-comparison frame into a stronger decoder-only transformer, or document that compact diagnostics have reached a bounded plateau. |

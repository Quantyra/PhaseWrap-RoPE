...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 63 enough to preserve capacity with a standard/free output path before testing positional-method promotion. |

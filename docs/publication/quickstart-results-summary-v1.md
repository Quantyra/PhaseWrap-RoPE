...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 56 enough to infer the phase-cued retrieval rule from standard inputs, then rerun the same fair comparison. |

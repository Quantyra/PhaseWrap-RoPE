...
| Next downstream gate | Stronger decoder-only transformer | Move beyond compact support/copy heads and test whether recovered support can drive token selection before positional-method promotion. |

...
| Next downstream gate | Stronger decoder-only transformer | Redesign beyond Stage 78 with an explicit support exposure contract before testing positional-method promotion. |

# Q-RoPE Bridge Anchor-Order Implementation v1

## Scope
- Task: `synthetic_positional_anchor_order_response`
- Witness: `V_future_relational_witness_positional_anchor_order`
- Control: `V_control_symbolic_positional_anchor_order_regressor`
- Backend: `sim_quantum_statevector`
- Seeds: `42`, `123`, `777`

## Implementation
- Added the anchor-order bridge-task synthetic generator to `src/qrope/synthetic.py`.
...
- Tightened the anchor-order feature basis so the continuous readout stays numerically stable under the frozen packet.

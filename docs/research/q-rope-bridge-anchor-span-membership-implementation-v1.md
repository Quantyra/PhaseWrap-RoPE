# Q-RoPE Bridge Anchor-Span-Membership Implementation v1

## Scope
- Task: `synthetic_positional_anchor_span_membership_response`
- Witness: `V_future_relational_witness_positional_anchor_span_membership`
- Control: `V_control_symbolic_positional_anchor_span_membership_regressor`
- Backend: `sim_quantum_statevector`
- Seeds: `42`, `123`, `777`

## Implementation
- Added the anchor-span-membership bridge-task synthetic generator to `src/qrope/synthetic.py`.

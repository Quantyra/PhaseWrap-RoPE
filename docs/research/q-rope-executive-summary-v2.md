...
- and it survived two bounded transfer cycles on materially different transfer families
...
- The current witness result survived a long fairness ladder and two bounded transfer-family hardening cycles.
...
- not broad generalization beyond the current benchmark plus the current bounded transfer families
...
- only open new execution if there is either:
  - a materially different third transfer family, or

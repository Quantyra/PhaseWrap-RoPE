# Q-RoPE Internal Result Package v13
...
- Next evidence priority: `only one materially different next bridge-task candidate if it clears the existing bridge admissibility bar`

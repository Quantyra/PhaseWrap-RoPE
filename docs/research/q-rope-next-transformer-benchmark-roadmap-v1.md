...
The next gate should redesign the stronger matched decoder-only transformer beyond Stage 63 enough to preserve learned capacity with a standard/free output path before testing positional-method promotion. Hardware witness hardening remains a separate replication track and should not displace the fair-comparison promotion path.

...
The next gate should redesign the stronger matched decoder-only transformer beyond Stage 61 enough to establish learned capacity before testing positional-method promotion. Hardware witness hardening remains a separate replication track and should not displace the fair-comparison promotion path.

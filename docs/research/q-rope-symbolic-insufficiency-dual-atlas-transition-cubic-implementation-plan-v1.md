# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Cubic Implementation Plan v1
...
- exactly these additional transition-cubic features:
  - `cell_ij_kl_source_to_dest_sector_times_orientation_times_content`
  - `cell_ij_kl_dest_to_source_sector_times_orientation_times_content`
...
- witness vs dual-atlas transition-cubic challenger
- seeds `42`, `123`, `777`

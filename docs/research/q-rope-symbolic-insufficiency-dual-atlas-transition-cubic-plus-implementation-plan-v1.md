# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Cubic-Plus Implementation Plan v1
...
- exactly these additional transition-cubic-plus features:
  - `cell_ij_kl_source_to_dest_sector_times_orientation_times_orientation_plus_content`
  - `cell_ij_kl_dest_to_source_sector_times_orientation_times_orientation_plus_content`
...
- witness vs dual-atlas transition-cubic-plus challenger
- seeds `42`, `123`, `777`

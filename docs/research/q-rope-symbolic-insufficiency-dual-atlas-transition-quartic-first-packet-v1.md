# Q-RoPE Symbolic-Insufficiency Dual-Atlas Transition-Quartic First Packet v1
...
- challenger: `V_control_symbolic_symbolic_insufficiency_regressor_dual_atlas_transition_quartic`
...
- challenger:
  - `mae = 0.309315`
  - `rank_correlation = 0.166104`
  - `calibration_slope = 0.104487`

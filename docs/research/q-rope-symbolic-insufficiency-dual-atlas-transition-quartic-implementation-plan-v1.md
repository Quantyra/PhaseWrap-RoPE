# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Quartic Implementation Plan v1
...
- exactly these additional transition-quartic features:
  - `cell_ij_kl_source_to_dest_sector_times_orientation_minus_content_times_orientation_plus_content`
  - `cell_ij_kl_dest_to_source_sector_times_orientation_minus_content_times_orientation_plus_content`
...
- witness vs dual-atlas transition-quartic challenger
- seeds `42`, `123`, `777`

# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Quartic-Plus Family v1

Date: 2026-03-11
Stories: S812

## Purpose
Define one materially stronger symbolic family beyond the dual-atlas transition-quartic control while preserving auditability and preventing hidden lookup behavior.

## Family Definition
- base family remains fixed through the dual-atlas transition-quartic contract
- stronger extension:
  - one bounded directional transition-quartic-plus family over the same frozen `4 x 4` lattice

# Q-RoPE Symbolic-Insufficiency Dual-Atlas Transition-Quartic-Plus First Packet v1
...
- challenger: `V_control_symbolic_symbolic_insufficiency_regressor_dual_atlas_transition_quartic_plus`
...
- challenger:
  - `mae = 0.309180`
  - `rank_correlation = 0.180876`
  - `calibration_slope = 0.108339`

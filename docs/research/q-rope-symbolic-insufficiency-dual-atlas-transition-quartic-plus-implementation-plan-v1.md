# Q-RoPE Symbolic-Insufficiency Dual-Atlas Transition-Quartic-Plus Implementation Plan v1
...
## Frozen Transition-Quartic-Plus Channels
...
- exactly these additional transition-quartic-plus features:
  - `cell_ij_kl_source_to_dest_sector_times_orientation_minus_content_times_orientation_plus_content_times_orientation_delta`
  - `cell_ij_kl_dest_to_source_sector_times_orientation_minus_content_times_orientation_plus_content_times_orientation_delta`
...
- witness vs dual-atlas transition-quartic-plus challenger
- seeds `42`, `123`, `777`

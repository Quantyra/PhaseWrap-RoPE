# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Quintic First Packet v1
...
- challenger: `V_control_symbolic_symbolic_insufficiency_regressor_dual_atlas_transition_quintic`
...
- challenger:
  - `mae = 0.309138`
  - `rank_correlation = 0.167089`
  - `calibration_slope = 0.109659`

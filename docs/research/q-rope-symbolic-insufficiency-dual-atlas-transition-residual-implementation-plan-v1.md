# Q-RoPE Symbolic Insufficiency Dual-Atlas Transition-Residual Implementation Plan v1
...
- all frozen residual-gating features
- all frozen bilinear residual features
- exactly these additional transition-residual features:
...
- witness vs dual-atlas transition-residual challenger
- seeds `42`, `123`, `777`

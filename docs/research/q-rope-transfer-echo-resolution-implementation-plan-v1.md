# Q-RoPE Transfer Echo-Resolution Implementation Plan v1
...
- bounded control: additive and bounded-quadratic regressor over declared `source`, `echo`, and `resolve` summaries only

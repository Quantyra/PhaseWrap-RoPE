# Q-RoPE Transfer Fork-Join Post-Pair-Reindex Decision v1
...
- the witness still led in the mean on:
  - `mae`
  - `rank_correlation`
- the remaining margin is now modest, so the branch needs another structural perturbation rather than broader interpretation

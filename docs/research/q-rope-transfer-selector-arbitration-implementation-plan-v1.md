# Q-RoPE Transfer Selector-Arbitration Implementation Plan v1
...
- bounded control: additive and bounded-quadratic regressor over declared `source`, `candidate`, and `selector` summaries only

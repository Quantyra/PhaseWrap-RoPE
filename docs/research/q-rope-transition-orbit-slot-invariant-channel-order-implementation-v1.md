# Q-RoPE Transition Orbit Slot-Invariant Channel-Order Implementation v1

Date: 2026-03-10
Stories: S478

## Scope
- task: `synthetic_transition_orbit_slot_invariant_channel_order_response`
...
- `coarse_slot_order_lookup_near_null_pass = true` on all runs

# Q-RoPE Transition Orbit Slot-Invariant Channel-Order Restart Scaffold v1
...
## Gate
- no implementation is valid unless the generator emits the latent slot-invariance diagnostics declared in the task spec

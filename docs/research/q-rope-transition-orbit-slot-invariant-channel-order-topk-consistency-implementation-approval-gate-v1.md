# Q-RoPE Transition Orbit Slot-Invariant Channel-Order Top-K Consistency Implementation Approval Gate v1
...
- do not interpret the packet if the generator fails:
  ...
  - `coarse_slot_topk_lookup_near_null_pass`
  - `within_state_topk_variation_pass`

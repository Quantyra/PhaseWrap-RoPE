# Q-RoPE Transition Orbit Slot-Invariant Top-K Pair-Order Signed Flip Hysteresis First Packet v1

Date: 2026-03-11
Stories: S641

## Packet
- task: `synthetic_transition_orbit_slot_invariant_topk_pair_order_signed_flip_hysteresis_binary`
- candidate: `V_future_relational_witness_transition_orbit_topk_pair_order_signed_flip_hysteresis_invariant`
- controls:
...
## Artifact
- summary csv: `logs/ablation_runs/summary/transition_orbit_topk_pair_order_signed_flip_hysteresis_invariant_v1.csv`

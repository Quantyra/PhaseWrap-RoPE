# Q-RoPE Transition Orbit Slot-Invariant Top-K Pair-Order Signed Flip Stability First Packet v1
...
## Summary Artifact
- `logs/ablation_runs/summary/transition_orbit_topk_pair_order_signed_flip_stability_invariant_v1.csv`

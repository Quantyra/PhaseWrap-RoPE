# Transition Orbit Split-Rotation Hardening v1
...
## Interpretation
- `split_rotation = 1` produced the same packet means as the base run.
- For this generator, split rotation is effectively inert.
- It does not count as new robustness evidence.

...
from qrope.stage16_learned_attention_stability import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run deterministic Stage 16 learned attention initialization-stability benchmark.")
    ...
    paths = write_stage16_outputs(result, args.output_dir)
    print_stage16_table(result)
    print(f"best_method_by_mean_top1_mrr: {result['best_method_by_mean_top1_mrr']}")

...
from qrope.stage24_long_context_value_model import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run deterministic Stage 24 long-context value-retrieval model benchmark.")
    ...
    paths = write_stage24_outputs(result, args.output_dir)
    print_stage24_table(result)

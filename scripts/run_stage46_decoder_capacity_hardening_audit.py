...
from qrope.stage46_decoder_capacity_hardening_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    DEFAULT_EXAMPLES_PER_LENGTH,
    DEFAULT_OUTPUT_DIR,
    print_stage46_summary,
    run_stage46_audit,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 46 decoder capacity/optimization hardening audit.")
    ...
    result = run_stage46_audit(seeds=args.seeds, examples_per_length=args.examples_per_length, epochs=args.epochs)
    paths = write_stage46_outputs(result, args.output_dir)
    print_stage46_summary(result)

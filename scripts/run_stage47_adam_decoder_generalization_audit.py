...
from qrope.stage47_adam_decoder_generalization_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    DEFAULT_EXAMPLES_PER_LENGTH,
    DEFAULT_LEARNING_RATE,
    DEFAULT_OUTPUT_DIR,
    print_stage47_summary,
    run_stage47_audit,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 47 Adam decoder generalization audit.")
    ...
    result = run_stage47_audit(
        seeds=args.seeds,
        examples_per_length=args.examples_per_length,
        epochs=args.epochs,
        learning_rate=args.learning_rate,
    )
    paths = write_stage47_outputs(result, args.output_dir)
    print_stage47_summary(result)

...
from qrope.stage48_adam_decoder_stability_audit import (  # noqa: E402
    DEFAULT_EPOCHS,
    DEFAULT_EXAMPLES_PER_LENGTH,
    DEFAULT_OUTPUT_DIR,
    DEFAULT_STABILITY_SEEDS,
    print_stage48_summary,
    run_stage48_audit,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 48 Adam decoder multi-seed stability audit.")
    parser.add_argument("--seeds", type=_parse_int_list, default=DEFAULT_STABILITY_SEEDS)
    ...
    result = run_stage48_audit(
        seeds=args.seeds,
        examples_per_length=args.examples_per_length,
        epochs=args.epochs,
        learning_rate=args.learning_rate,
    )
    paths = write_stage48_outputs(result, args.output_dir)
    print_stage48_summary(result)

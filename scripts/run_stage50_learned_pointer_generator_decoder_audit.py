...
from qrope.stage50_learned_pointer_generator_decoder_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    DEFAULT_EXAMPLES_PER_LENGTH,
    DEFAULT_OUTPUT_DIR,
    print_stage50_summary,
    run_stage50_audit,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 50 learned pointer-generator decoder audit.")
    ...
    paths = write_stage50_outputs(result, args.output_dir)
    print_stage50_summary(result)

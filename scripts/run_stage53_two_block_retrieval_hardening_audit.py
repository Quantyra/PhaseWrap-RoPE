...
from qrope.stage53_two_block_retrieval_hardening_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    DEFAULT_EXAMPLES_PER_LENGTH,
    DEFAULT_OUTPUT_DIR,
    print_stage53_summary,
    run_stage53_audit,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 53 two-block retrieval hardening audit.")
    ...
    paths = write_stage53_outputs(result, args.output_dir)
    print_stage53_summary(result)

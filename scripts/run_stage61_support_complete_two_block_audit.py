...
from qrope.stage61_support_complete_two_block_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 61 support-complete two-block decoder audit.")
    ...
    result = run_stage61_audit(seeds=args.seeds, examples_per_length=args.examples_per_length, epochs=args.epochs)
    paths = write_stage61_outputs(result, args.output_dir)

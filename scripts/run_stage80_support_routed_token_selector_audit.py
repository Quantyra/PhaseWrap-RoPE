...
from qrope.stage80_support_routed_token_selector_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
    ...
    print_stage80_summary,
    run_stage80_audit,
    write_stage80_outputs,
)
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 80 support-routed token selector audit.")
    ...
    paths = write_stage80_outputs(result, args.output_dir)
    print_stage80_summary(result)

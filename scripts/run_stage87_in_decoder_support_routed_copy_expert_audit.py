...
from qrope.stage87_in_decoder_support_routed_copy_expert_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 87 in-decoder support-routed copy expert audit.")
    ...
    paths = write_stage87_outputs(result, args.output_dir)
    print_stage87_summary(result)

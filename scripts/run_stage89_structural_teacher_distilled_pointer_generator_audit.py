...
from qrope.stage89_structural_teacher_distilled_pointer_generator_audit import (  # noqa: E402
    DEFAULT_AUDIT_SEEDS,
    DEFAULT_EPOCHS,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Run Stage 89 structural-teacher distilled pointer-generator audit.")
    ...
    paths = write_stage89_outputs(result, args.output_dir)
    print_stage89_summary(result)

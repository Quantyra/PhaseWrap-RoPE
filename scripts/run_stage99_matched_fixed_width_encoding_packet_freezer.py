...
from qrope.stage99_matched_fixed_width_encoding_packet_freezer import (  # noqa: E402
    DEFAULT_OUTPUT_DIR,
    DEFAULT_SOURCE_PACKET_DIR,
    DEFAULT_SOURCE_PACKET_FILES,
    print_stage99_summary,
    run_stage99_freezer,
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Freeze Stage 99 matched fixed-width encoding packets.")
    ...
    result = run_stage99_freezer(source_packet_dir=args.source_packet_dir, source_packet_files=source_packet_files)
    paths = write_stage99_outputs(result, args.output_dir)
    print_stage99_summary(result)
